...
const Hero = ({title, imageUrl}) => {
  return (
    <main className={heroStyles.main_section}>
        <div className={styles.container}>
            <div className={styles.grid_two_section}>
                <div className={heroStyles.hero_content}>
                    <h1>{title}</h1>
                  <p>From award-winning dramas to blockbuster action movies, we&apos;ve got you covered. Browse our selection of the latest movies, and find your new favorite today.</p>
                 <Link href={"/movie"}>
        ...
        <div className={heroStyles['custom-shape-divider-bottom-1683108979']}>
